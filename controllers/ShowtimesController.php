...
// Chức năng: CRUD lịch chiếu, lọc theo ngày/trạng thái/rạp, phân quyền (Admin xem tất cả, Manager/Staff chỉ rạp được gán)
class ShowtimesController
{
    ...
    // Danh sách lịch chiếu (Admin/Manager/Staff) - có phân trang, lọc theo ngày/trạng thái/rạp
    ...
    // Tạo lịch chiếu mới (Admin/Manager) - validate, kiểm tra conflict, insert vào DB
    ...
    // Hiển thị form sửa lịch chiếu (Admin/Manager) - validate, kiểm tra conflict, update
    ...
    // Lấy danh sách rạp (private helper)
    ...
    // Lấy danh sách phòng (private helper)
    ...
    // API lấy lịch chiếu theo phim (AJAX)
    ...
    // API lấy lịch chiếu theo ngày (AJAX)
