...
class ShowtimesController
{
    ...
    public function list()
    {
        ...
        // Lấy dữ liệu phân trang (chỉ lấy lịch chiếu của phim đang chiếu/sắp chiếu)
        $result = $this->showtime->paginate($page, 5, $date);
        
        // Lấy danh sách phim đang chiếu/sắp chiếu và phòng cho filter
        $movies = $this->movie->getActiveAndComingSoonMovies();
        $rooms = $this->getRooms();
