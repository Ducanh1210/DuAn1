...
class NotificationController
{
    ...
    /**
     * API endpoint: Lấy danh sách notifications (Admin hoặc Client)
     */
    ...
    /**
     * API endpoint: Đếm số notifications chưa đọc (Admin hoặc Client)
     */
    ...
    /**
     * API endpoint: Đánh dấu notification là đã đọc (Admin hoặc Client)
     */
