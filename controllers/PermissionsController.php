<?php
// PERMISSIONS CONTROLLER - Xử lý logic phân quyền
// Chức năng: Xem danh sách phân quyền, gán quyền cho role (chỉ Admin)
class PermissionsController
{
    public $permission; // Model Permission để tương tác với database

    public function __construct()
    {
        $this->permission = new Permission(); // Khởi tạo Model Permission
    }

    // Danh sách phân quyền (Admin) - xem user nào có quyền gì
    ...
    // Phân quyền cho role (Manager hoặc Staff) - gán quyền vào bảng permissions
