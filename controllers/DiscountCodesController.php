<?php
// DISCOUNT CODES CONTROLLER - Xử lý logic quản lý mã giảm giá
// Chức năng: CRUD mã giảm giá (Admin)
class DiscountCodesController
{
    ...
    // Hiển thị form tạo mã giảm giá mới (Admin) - validate, insert vào DB
    ...
    // Hiển thị form sửa mã giảm giá (Admin) - validate, update
