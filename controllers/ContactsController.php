...
// CONTACTS CONTROLLER - Xử lý logic quản lý liên hệ
// Chức năng: CRUD liên hệ, phân trang, lọc theo trạng thái/rạp (Admin xem tất cả, Manager/Staff chỉ rạp được gán)
class ContactsController
{
    public $contact; // Model Contact để tương tác với database

    public function __construct()
    {
        $this->contact = new Contact(); // Khởi tạo Model Contact
    }

    // Danh sách liên hệ (Admin/Manager/Staff) - có phân trang, lọc theo trạng thái/rạp
    ...
    // Hiển thị form sửa liên hệ (Admin/Manager/Staff) - validate, update
    ...
    // Cập nhật trạng thái liên hệ (pending/processing/resolved/closed)
