...
class ContactsController
{
    ...
    /**
     * Hiển thị danh sách liên hệ (Admin/Staff)
     */
    public function list()
    {
        require_once __DIR__ . '/../commons/auth.php';
        requireAdminOrStaff(); // Cho phép admin và staff truy cập
        ...
        if (isAdmin()) {
            ...
            // Staff chỉ xem phản hồi của rạp được gán
    ...
    /**
     * Xem chi tiết liên hệ (Admin/Staff)
     */
    public function show()
    {
        ...
        // Kiểm tra quyền: Staff chỉ xem phản hồi của rạp mình
        if (isStaff()) {
            $currentCinemaId = getCurrentCinemaId();
    ...
    /**
     * Hiển thị form sửa liên hệ (Admin/Staff)
     */
    public function edit()
    {
        ...
        // Kiểm tra quyền: Staff chỉ sửa phản hồi của rạp mình
        if (isStaff()) {
            $currentCinemaId = getCurrentCinemaId();
            if ($contact['cinema_id'] != $currentCinemaId) {
                header('Location: ' . BASE_URL . '?act=contacts');
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isStaff()) {
                ...
                // Admin và Manager có thể sửa tất cả thông tin
    ...
    public function updateStatus()
    {
        ...
        // Kiểm tra quyền: Staff chỉ cập nhật phản hồi của rạp mình
        $contact = $this->contact->find($id);
        if (!$contact) {
            if (session_status() === PHP_SESSION_NONE) {
                session_start();
