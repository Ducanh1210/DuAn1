...
match ($act) {
    ...
    // DISCOUNTS ROUTES - Quản lý mã giảm giá / chương trình khuyến mãi (Admin)
    // NOTE: Consolidated to use DiscountCodesController to avoid duplicate route namespaces.
    'discounts' => (new DiscountsController)->list(), // Danh sách mã khuyến mãi
    'discounts-create' => (new DiscountsController)->create(), // Tạo mã giảm giá mới
    'discounts-edit' => (new DiscountsController)->edit(), // Sửa mã giảm giá
    'discounts-delete' => (new DiscountsController)->delete(), // Xóa mã giảm giá
    ...
    // (legacy 'discount-codes' routes removed — consolidated under 'discounts')
