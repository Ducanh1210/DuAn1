...
// Chức năng: CRUD lịch chiếu, phân trang, lọc theo ngày/trạng thái/rạp, tính trạng thái, kiểm tra conflict
class Showtime
{
    ...
    // Lấy tất cả lịch chiếu với thông tin phim và phòng (chỉ lấy phim đang chiếu)
    public function all()
    {
        try {
    ...
    // Tính trạng thái của showtime: 'upcoming' (sắp chiếu), 'showing' (đang chiếu), 'ended' (dừng)
    ...
    // Lấy lịch chiếu với phân trang (có thể lọc theo ngày, trạng thái, rạp)
    ...
    // Lấy lịch chiếu với phân trang theo cinema_id (có thể lọc theo ngày, trạng thái)
    ...
    // Lấy lịch chiếu theo phim (chỉ lấy phim đang chiếu)
    ...
    // Lấy lịch chiếu theo phim và ngày (có thể lọc theo rạp, chỉ lấy phim đang chiếu)
    ...
    // Lấy lịch chiếu theo ngày (có thể lọc theo rạp/phim, chỉ lấy phim đang chiếu)
    ...
    // Lấy lịch chiếu theo phòng (có thể lọc theo ngày, chỉ lấy phim đang chiếu)
    ...
    // Lấy lịch chiếu sắp tới (từ hôm nay, chỉ lấy phim đang chiếu)
    ...
    // Kiểm tra xung đột lịch chiếu (trùng giờ, cùng phòng, exclude_id để bỏ qua khi update)
    ...
    // Validate dữ liệu lịch chiếu (isUpdate=true khi update, false khi insert)
    ...
    // Lấy danh sách ngày có lịch chiếu (mặc định 7 ngày)
