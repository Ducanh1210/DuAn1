<?php
// SEAT MODEL - Tương tác với bảng seats
// Chức năng: CRUD ghế, phân trang, lấy sơ đồ ghế theo phòng
class Seat
{
    ...
    // Lấy tất cả ghế với thông tin phòng và rạp (LEFT JOIN)
    public function all()
    {
        try {
            $sql = "SELECT seats.*, 
    ...
    // Lấy ghế với phân trang (có thể lọc theo phòng)
