...
// Chức năng: CRUD phòng, phân trang, lọc theo rạp
class Room
{
    ...
    // Lấy tất cả phòng với thông tin rạp (LEFT JOIN)
    public function all()
    {
        try {
    ...
    // Lấy phòng với phân trang (có thể lọc theo rạp, tìm kiếm theo tên/mã phòng)
