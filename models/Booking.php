...
// Chức năng: CRUD đặt vé, phân trang, lấy ghế đã đặt, kiểm tra user đã mua vé
class Booking
{
    ...
    // Lấy tất cả đặt vé với thông tin liên quan (JOIN với users, showtimes, movies, rooms, cinemas)
    public function all()
    {
        try {
    ...
    // Lấy đặt vé với phân trang (có thể lọc theo trạng thái và ngày)
