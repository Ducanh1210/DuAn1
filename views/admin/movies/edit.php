          ...
          <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <select name="format" id="format"
                ...
                <option value="IMAX" <?= (isset($_POST['format']) ? $_POST['format'] : $movie['format'] ?? '') == 'IMAX' ? 'selected' : '' ?>>IMAX</option>
                <option value="4DX" <?= (isset($_POST['format']) ? $_POST['format'] : $movie['format'] ?? '') == '4DX' ? 'selected' : '' ?>>4DX</option>
              </select>
