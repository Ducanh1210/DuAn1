        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <select name="room_id" id="room_id" class="form-select <?= !empty($errors['room_id']) ? 'is-invalid' : '' ?>" required <?= empty($currentCinemaId) ? 'disabled' : '' ?>>
            ...
            <div class="mb-3">
              ...
              <input type="time" name="start_time" id="start_time" 
                     ...
                     value="<?= htmlspecialchars($_POST['start_time'] ?? ($showtime['start_time'] ?? '')) ?>" required>
            ...
            <div class="mb-3">
              ...
              <input type="time" name="end_time" id="end_time" 
                     ...
                     value="<?= htmlspecialchars($_POST['end_time'] ?? ($showtime['end_time'] ?? '')) ?>" required>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="number" name="adult_price" id="adult_price" 
                     ...
                     min="0" step="1000" 
                     value="<?= htmlspecialchars($_POST['adult_price'] ?? ($showtime['adult_price'] ?? '')) ?>" required>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="student_price" id="student_price" 
                     ...
                     min="0" step="1000" 
                     value="<?= htmlspecialchars($_POST['student_price'] ?? ($showtime['student_price'] ?? '')) ?>" required>
