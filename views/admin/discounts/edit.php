              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="number" 
                         ...
                         value="<?= htmlspecialchars($_POST['usage_limit'] ?? ($discount['usage_limit'] ?? '')) ?>" 
                         min="0"
                         placeholder="Để trống nếu không giới hạn">
                  <small class="form-text text-muted">
                    Mỗi ghế dùng mã trừ 1 lượt. Đã dùng: <?= (int)($discount['usage_used'] ?? 0) ?> lượt.
                  </small>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="number" 
                         ...
                         value="<?= htmlspecialchars($_POST['usage_used'] ?? ($discount['usage_used'] ?? 0)) ?>" 
                         min="0"
                         placeholder="0">
                  <small class="form-text text-muted">
                    Bạn có thể điều chỉnh lượt đã dùng (hỗ trợ reset hoặc đồng bộ số liệu).
                  </small>
