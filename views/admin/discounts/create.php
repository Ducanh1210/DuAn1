      ...
      <form action="" method="post">
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label for="usage_used" class="form-label">Lượt đã sử dụng</label>
                  <input type="number"
                         name="usage_used"
                         id="usage_used"
                         class="form-control <?= !empty($errors['usage_used']) ? 'is-invalid' : '' ?>"
                         value="<?= htmlspecialchars($_POST['usage_used'] ?? '0') ?>"
                         min="0"
                         placeholder="0">
                  <small class="form-text text-muted">Cho phép thiết lập lượt đã dùng (mặc định 0).</small>
                  <?php if (!empty($errors['usage_used'])): ?>
                    <div class="text-danger small mt-1"><?= $errors['usage_used'] ?></div>
                  <?php endif; ?>
                </div>
              </div>
              <div class="col-md-4">
            ...
            <div class="mb-3">
              ...
              <textarea name="description" 
                        ...
                        rows="4" 
                        placeholder="Mô tả về mã khuyến mại này..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            ...
            <div class="mb-3">
              ...
              <textarea name="benefits" 
                        ...
                        class="form-control" 
                        rows="4" 
                        placeholder="VD:&#10;Áp dụng cho suất chiếu cuối tuần&#10;Giảm 25% cho mọi vé&#10;Không giới hạn số lượng vé"><?= htmlspecialchars($_POST['benefits'] ?? '') ?></textarea>
            ...
            <div class="mb-3">
              ...
              <input type="text" 
                     ...
                     id="cta" 
                     class="form-control" 
                     value="<?= htmlspecialchars($_POST['cta'] ?? '') ?>" 
        ...
        <div class="mt-4">
          <button type="submit" class="btn btn-primary">
            <i class="bi bi-check-circle"></i> Thêm mã khuyến mại
          </button>
          <a href="<?= BASE_URL ?>?act=discounts" class="btn btn-secondary">
