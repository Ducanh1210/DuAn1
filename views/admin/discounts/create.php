<div class="container-fluid">
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h4 class="mb-0">Thêm mã giảm giá mới</h4>
          ...
          <div class="col-md-8">
            ...
            <div class="mb-3">
              ...
              <textarea name="description" 
                        ...
                        rows="4" 
                        placeholder="Mô tả về mã giảm giá này..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            ...
            <div class="mb-3">
              ...
              <textarea name="benefits" 
                        ...
                        rows="4" 
                        placeholder="VD:&#10;Áp dụng tối đa 04 vé/đơn&#10;Thời gian: 10h - 22h&#10;Không áp dụng cho ghế Sweetbox"><?php
                $benefitsValue = '';
